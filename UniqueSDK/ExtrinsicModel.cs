                ...
                switch (status.ExtrinsicState)
                {
                    ...
                    case ExtrinsicState.Finalized:
                        ...
                        foreach (var e in allExtrinsicEvents)
                        {
                            ...
                            if (e.Event.Value == Substrate.Opal.NET.NetApiExt.Generated.Model.opal_runtime.RuntimeEvent.System)
                            {
                                var commonEvent = (Substrate.Opal.NET.NetApiExt.Generated.Model.frame_system.pallet.EnumEvent)e.Event.Value2;

                                if (commonEvent.Value == Substrate.Opal.NET.NetApiExt.Generated.Model.frame_system.pallet.Event.ExtrinsicSuccess)
                                {
                                    collectionIdTask.TrySetResult(ExtrinsicResult.Success);

                                    return;
                                }
                                else if (commonEvent.Value == Substrate.Opal.NET.NetApiExt.Generated.Model.frame_system.pallet.Event.ExtrinsicFailed)
                                {
                                    collectionIdTask.TrySetResult(ExtrinsicResult.Failed);
...
#pragma warning disable VSTHRD101 // Avoid unsupported async delegates
            Action<string, ExtrinsicStatus> callback = async (string id, ExtrinsicStatus status) =>
            {
                ...
                // Skip if does not want to wait for finality
                if (!waitForFinality)
                {
                    return;
                }
                ...
                switch (status.ExtrinsicState)
                {
                    ...
                    case ExtrinsicState.Finalized:
                        ...
                        {
                            // Filter only Common.CollectionCreated events
                            if (e.Event.Value == Substrate.Unique.NET.NetApiExt.Generated.Model.unique_runtime.RuntimeEvent.System)
                            {
                                var commonEvent = (Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system.pallet.EnumEvent)e.Event.Value2;

                                if (commonEvent.Value == Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system.pallet.Event.ExtrinsicSuccess)
                                {
                                    collectionIdTask.TrySetResult(ExtrinsicResult.Success);

                                    return;
                                }
                                else if (commonEvent.Value == Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system.pallet.Event.ExtrinsicFailed)
                                {
                                    collectionIdTask.TrySetResult(ExtrinsicResult.Failed);
