...
namespace UniqueSDK
{
	public static class BalancesModel
	{
        ...
        public static async Task<AccountInfo> GetAccountInfoAsync(
            ...
            Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 accountId32,
        ...
        public static async Task<AccountInfo> GetAccountInfoAsync(
            ...
            Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 accountId32,
            NetworkEnum network = NetworkEnum.Unique,
            CancellationToken cancellationToken = default
        )
        {
            Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system.AccountInfo accountInfo = await substrateClient.SystemStorage.Account(
                accountId32,
                null,
                cancellationToken
            );
        ...
        {
            return await substrateClient.GetAccountInfoAsync(address.ToOpalAccountId32(), network, cancellationToken);
        }
        ...
        {
            return await substrateClient.GetAccountInfoAsync(address.ToUniqueAccountId32(), network, cancellationToken);
        }
        ...
        {
            return await substrateClient.GetAccountInfoAsync(account.ToOpalAccountId32(), network, cancellationToken);
        }
        ...
        {
            return await substrateClient.GetAccountInfoAsync(account.ToUniqueAccountId32(), network, cancellationToken);
        }
