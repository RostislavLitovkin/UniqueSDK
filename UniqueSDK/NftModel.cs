                    ...
                    case ExtrinsicState.Finalized:
                        ...
                        foreach (var e in allExtrinsicEvents)
                        {
                            ...
                            if (e.Event.Value == Substrate.Opal.NET.NetApiExt.Generated.Model.opal_runtime.RuntimeEvent.Common)
                            {
                                ...
                                {
                                    var createdItemEvent = (BaseTuple<
                                        Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.CollectionId,
                                        Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.TokenId,
                                        Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr,
                                        U128
                                    >)commonEvent.Value2;

                                    tokenIdTask.TrySetResult(((Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.TokenId)createdItemEvent.Value[1]).Value);
                    ...
                    case ExtrinsicState.Finalized:
                        ...
                        foreach (var e in allExtrinsicEvents)
                        {
                            ...
                            if (e.Event.Value == Substrate.Unique.NET.NetApiExt.Generated.Model.unique_runtime.RuntimeEvent.Common)
                            {
                                ...
                                if (commonEvent.Value == Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_common.pallet.Event.ItemCreated)
                                {
                                    var createdItemEvent = (BaseTuple<
                                        Substrate.Unique.NET.NetApiExt.Generated.Model.up_data_structs.CollectionId,
                                        Substrate.Unique.NET.NetApiExt.Generated.Model.up_data_structs.TokenId,
                                        Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr,
                                        U128
                                    >)commonEvent.Value2;

                                    tokenIdTask.TrySetResult(((Substrate.Unique.NET.NetApiExt.Generated.Model.up_data_structs.TokenId)createdItemEvent.Value[1]).Value);
