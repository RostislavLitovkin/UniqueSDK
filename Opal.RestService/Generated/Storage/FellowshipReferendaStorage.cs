...
namespace Opal.RestService.Generated.Storage
{
    ...
    public interface IFellowshipReferendaStorage : IStorage
    {
        ...
        /// </summary>
        Opal.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo GetReferendumInfoFor(string key);
        ...
        /// </summary>
        Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36 GetTrackQueue(string key);
    ...
    public sealed class FellowshipReferendaStorage : IFellowshipReferendaStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo> _referendumInfoForTypedStorage;
        
        /// <summary>
        /// _trackQueueTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36> _trackQueueTypedStorage;
        ...
        public FellowshipReferendaStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ReferendumInfoForTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo>("FellowshipReferenda.ReferendumInfoFor", storageDataProvider, storageChangeDelegates);
            this.TrackQueueTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36>("FellowshipReferenda.TrackQueue", storageDataProvider, storageChangeDelegates);
            ...
            this.MetadataOfTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.primitive_types.H256>("FellowshipReferenda.MetadataOf", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoForTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36> TrackQueueTypedStorage
        {
            get
            {
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo GetReferendumInfoFor(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReferendumInfoForTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo result))
            {
                return result;
            }
            else
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36 GetTrackQueue(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TrackQueueTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36 result))
            {
                return result;
            }
            else
