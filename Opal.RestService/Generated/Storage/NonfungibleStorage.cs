...
namespace Opal.RestService.Generated.Storage
{
    ...
    public interface INonfungibleStorage : IStorage
    {
        ...
        /// </summary>
        Opal.NetApiExt.Generated.Model.pallet_nonfungible.ItemData GetTokenData(string key);
        
        /// <summary>
        /// >> TokenProperties
        ///  Map of key-value pairs, describing the metadata of a token.
        /// </summary>
        Opal.NetApiExt.Generated.Model.up_data_structs.PropertiesT2 GetTokenProperties(string key);
        ...
        ///  Currently unused.
        /// </summary>
        Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41 GetTokenAuxProperties(string key);
        ...
        /// </summary>
        Opal.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr GetAllowance(string key);
    ...
    public sealed class NonfungibleStorage : INonfungibleStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_nonfungible.ItemData> _tokenDataTypedStorage;
        
        /// <summary>
        /// _tokenPropertiesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.up_data_structs.PropertiesT2> _tokenPropertiesTypedStorage;
        
        /// <summary>
        /// _tokenAuxPropertiesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41> _tokenAuxPropertiesTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr> _allowanceTypedStorage;
        ...
        public NonfungibleStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.TokenDataTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_nonfungible.ItemData>("Nonfungible.TokenData", storageDataProvider, storageChangeDelegates);
            this.TokenPropertiesTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.up_data_structs.PropertiesT2>("Nonfungible.TokenProperties", storageDataProvider, storageChangeDelegates);
            this.TokenAuxPropertiesTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41>("Nonfungible.TokenAuxProperties", storageDataProvider, storageChangeDelegates);
            ...
            this.AllowanceTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr>("Nonfungible.Allowance", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_nonfungible.ItemData> TokenDataTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.up_data_structs.PropertiesT2> TokenPropertiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41> TokenAuxPropertiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr> AllowanceTypedStorage
        {
            get
            {
        ...
        ///  Token data, used to partially describe a token.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.pallet_nonfungible.ItemData GetTokenData(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TokenDataTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.pallet_nonfungible.ItemData result))
            {
                return result;
            }
            else
        ...
        ///  Map of key-value pairs, describing the metadata of a token.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.up_data_structs.PropertiesT2 GetTokenProperties(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TokenPropertiesTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.up_data_structs.PropertiesT2 result))
            {
                return result;
            }
            else
        ...
        ///  Currently unused.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41 GetTokenAuxProperties(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TokenAuxPropertiesTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41 result))
            {
                return result;
            }
            else
        ...
        ///  Allowance set by a token owner for another user to perform one of certain transactions on a token.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr GetAllowance(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AllowanceTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr result))
            {
                return result;
            }
            else
