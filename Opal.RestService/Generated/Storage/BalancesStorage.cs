...
namespace Opal.RestService.Generated.Storage
{
    ...
    public interface IBalancesStorage : IStorage
    {
        ...
        /// </summary>
        Opal.NetApiExt.Generated.Model.pallet_balances.types.AccountData GetAccount(string key);
        ...
        /// </summary>
        Opal.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2 GetLocks(string key);
        
        /// <summary>
        /// >> Reserves
        ///  Named reserves on some account balances.
        /// </summary>
        Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20 GetReserves(string key);
        
        /// <summary>
        /// >> Holds
        ///  Holds on account balances.
        /// </summary>
        Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetHolds(string key);
        
        /// <summary>
        /// >> Freezes
        ///  Freeze locks on account balances.
        /// </summary>
        Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT22 GetFreezes(string key);
    }
    ...
    public sealed class BalancesStorage : IBalancesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_balances.types.AccountData> _accountTypedStorage;
        
        /// <summary>
        /// _locksTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2> _locksTypedStorage;
        
        /// <summary>
        /// _reservesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20> _reservesTypedStorage;
        
        /// <summary>
        /// _holdsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21> _holdsTypedStorage;
        
        /// <summary>
        /// _freezesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT22> _freezesTypedStorage;
        ...
        public BalancesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AccountTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_balances.types.AccountData>("Balances.Account", storageDataProvider, storageChangeDelegates);
            this.LocksTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2>("Balances.Locks", storageDataProvider, storageChangeDelegates);
            this.ReservesTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20>("Balances.Reserves", storageDataProvider, storageChangeDelegates);
            this.HoldsTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21>("Balances.Holds", storageDataProvider, storageChangeDelegates);
            this.FreezesTypedStorage = new TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT22>("Balances.Freezes", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.pallet_balances.types.AccountData> AccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2> LocksTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20> ReservesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21> HoldsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT22> FreezesTypedStorage
        {
            get
            {
        ...
        ///  NOTE: This is only used in the case that this pallet is used to store balances.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.pallet_balances.types.AccountData GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.pallet_balances.types.AccountData result))
            {
                return result;
            }
            else
        ...
        ///  NOTE: Should only be accessed when setting, changing and freeing a lock.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2 GetLocks(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LocksTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2 result))
            {
                return result;
            }
            else
        ...
        ///  Named reserves on some account balances.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20 GetReserves(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReservesTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20 result))
            {
                return result;
            }
            else
        ...
        ///  Holds on account balances.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetHolds(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (HoldsTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 result))
            {
                return result;
            }
            else
        ...
        ///  Freeze locks on account balances.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT22 GetFreezes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (FreezesTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT22 result))
            {
                return result;
            }
            else
