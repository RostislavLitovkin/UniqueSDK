...
namespace Opal.RestService.Generated.Storage
{
    ...
    public interface IAuraStorage : IStorage
    {
        ...
        /// </summary>
        Opal.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot();
    }
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        /// </summary>
        private TypedStorage<Opal.NetApiExt.Generated.Model.sp_consensus_slots.Slot> _currentSlotTypedStorage;
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Opal.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT19>("Aura.Authorities", storageDataProvider, storageChangeDelegates);
            this.CurrentSlotTypedStorage = new TypedStorage<Opal.NetApiExt.Generated.Model.sp_consensus_slots.Slot>("Aura.CurrentSlot", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Opal.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlotTypedStorage
        {
            get
            {
        ...
        ///  This will be set in `on_initialize`.
        /// </summary>
        public Opal.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot()
        {
